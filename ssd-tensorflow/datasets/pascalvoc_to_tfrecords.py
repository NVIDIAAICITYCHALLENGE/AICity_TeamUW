...
DIRECTORY_FILES = {'train':'ImageSets/Main/train.txt','val':'ImageSets/Main/val.txt','test':'ImageSets/Main/test.txt'}
...
def run(dataset_dir, output_dir, name='train', splitname='train', shuffling=True):
    ...
    filepath = os.path.join(dataset_dir,DIRECTORY_FILES[splitname])
    filenames = open(filepath).readlines() 
    ...
    #print filenames[0]
    #print filenames[0][31]
    #print filenames[0][32]
    #print filenames[0][33]
