...
public:
	...
	inline void setBgImgPath(const char* bg_img_path) { strcpy_s(m_BgImgPath, MAX_PATH, bg_img_path); }
	inline void setBgRoiPath(const char* roi_img_path) { strcpy_s(m_RoiImgPath, MAX_PATH, roi_img_path); }
